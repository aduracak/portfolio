...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      id: 2,
      title: "Flowin - Task Management Platform",
      category: "Full Stack",
      year: "2024",
      description: "A modern, feature-rich task management platform with real-time collaboration, Kanban boards, and Firebase integration.",
      fullDescription: "Flowin is a comprehensive task management application built with React, TypeScript, and Firebase. It features an intuitive Kanban board interface with drag-and-drop functionality, real-time collaboration across devices, secure authentication, and a beautiful dark/light mode design. The platform includes project management, team collaboration, task prioritization, and responsive design that works perfectly on all devices.",
      image: "https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=800&h=600&fit=crop&q=80",
      technologies: ["React 18", "TypeScript", "Firebase", "Firestore", "Framer Motion", "Tailwind CSS", "Vite", "DnD Kit"],
      github: "https://github.com/aduracak/flowin-app",
      demo: "https://flowin-app.vercel.app",
      timeline: "1 month",
      features: [
        "Kanban board with drag-and-drop functionality",
        "Real-time collaboration using Firestore",
        "Firebase Authentication with email/password",
        "Project and task management with priorities",
        "Dark/Light mode with system preference detection",
        "Responsive design for all devices",
        "Custom logo branding and professional UI",
